...
InitForRoom:
  ...
  sta zp.lift_speed_dir               // [1F7D:85 98    STA $0098]
  sta zp.lift_contains_monty          // [1F7F:85 99    STA $0099]
  lda zp.room_id                      // [1F81:a5 46    LDA $0046]
  cmp #$05                            // [1F83:c9 05    CMP #$5]
  bne !+                              // [1F85:d0 16    BNE $1f9d]
  lda #$48                            // [1F87:a9 48    LDA #$48]
  sta zp.lift_x                       // [1F89:85 95    STA $0095]
  lda #$5b                            // [1F8B:a9 5b    LDA #$5b]
  sta zp.lift_y                       // [1F8D:85 96    STA $0096]
...
!:
  ...
  sta zp.lift_x                       // [1FA3:85 95    STA $0095]
  lda #$53                            // [1FA5:a9 53    LDA #$53]
  sta zp.lift_y                       // [1FA7:85 96    STA $0096]
  lda #$02                            // [1FA9:a9 02    LDA #$2]
  sta zp.lift_type                    // [1FAB:85 97    STA $0097]
  lda #$80                            // [1FAD:a9 80    LDA #$80]
  sta zp.lift_speed_dir               // [1FAF:85 98    STA $0098]
!:
  rts                                 // [1FB1:60       RTS]
...
!:
  ...
  lda zp.lift_contains_monty          // [1FEA:a5 99    LDA $0099]
  beq !+                              // [1FEC:f0 07    BEQ $1ff5]
  lda zp.lift_y                       // [1FEE:a5 96    LDA $0096]
  clc                                 // [1FF0:18       CLC]
...
MovementUpdate_stop:
  ...
  sta zp.lift_speed_dir               // [201C:85 98    STA $0098]
  sta zp.lift_contains_monty          // [201E:85 99    STA $0099]
  sta zp.game_mode                    // [2020:85 39    STA $0039]
  rts                                 // [2022:60       RTS]
!:
  lda zp.lift_y                       // [2023:a5 96    LDA $0096]
  clc                                 // [2025:18       CLC]
  adc zp.lift_speed                   // [2026:65 9a    ADC $009a]
  sta zp.lift_y                       // [2028:85 96    STA $0096]
...
MovementUpdate_asc:
  ...
  rts                                 // [2048:60       RTS]
!:
  lda zp.lift_y                       // [2049:a5 96    LDA $0096]
  sec                                 // [204B:38       SEC]
  sbc zp.lift_speed                   // [204C:e5 9a    SBC $009a]
  sta zp.lift_y                       // [204E:85 96    STA $0096]
...
//          Sets zp.lift_contains_monty (riding flag) and zp.game_mode. Plays boarding SFX.
//==============================================================================
                                      // XREF[1]: 0dc5(c)
CheckContact:
  lda zp.lift_type                    // [2056:a5 97    LDA $0097]
  beq CheckContact_exit               // [2058:f0 4d    BEQ $20a7]
  lda zp.lift_contains_monty          // [205A:a5 99    LDA $0099]
  ...
  lda zp.lift_y                       // [2064:a5 96    LDA $0096]
...
!:
  lda zp.lift_y                       // [206B:a5 96    LDA $0096]
  clc                                 // [206D:18       CLC]
...
!:
  lda zp.lift_x                       // [207F:a5 95    LDA $0095]
  clc                                 // [2081:18       CLC]
  ...
  sta zp.lift_contains_monty          // [208A:85 99    STA $0099]
...
UpdateBgTile:
  ldy zp.lift_y                       // [20A8:a4 96    LDY $0096]
...
!:
  ...
  lda zp.lift_x                       // [20BF:a5 95    LDA $0095]
  sec                                 // [20C1:38       SEC]
